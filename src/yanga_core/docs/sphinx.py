...
from yanga_core.domain.reports import ComponentReportData, ReportData, VariantReportData
...
class SphinxReportConfig(ReportData):
    ...
    def create_component_myst_toc(self, component_name: str, maxdepth: int = 1, caption: str | None = None) -> str:
