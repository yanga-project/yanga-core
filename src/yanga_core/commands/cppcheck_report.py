...
def create_doc_structure(cppcheck_data: CppCheckResults, component_name: str, context_lines: int = 3, project_dir: Path | None = None) -> DocStructure:
...
def _create_file_section(file_path: Path, file_errors: list[CppCheckError], context_lines: int, project_dir: Path | None = None) -> Section:
